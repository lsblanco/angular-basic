    ...
    var data = [
      {
        ...
        'header': 'assets/images/guideitems/angular-style-todd-header.jpg',
        ...
        'avatarSrc': 'assets/images/guideitems/john-avatar.png',
        'avatarUrl' : 'https://johnpapa.net/',
        'author': 'John Papa',
        'position': 'Angular Consultant',
        'header': 'assets/images/guideitems/angular-patterns-john-header.png',
        ...
        'avatarSrc': 'assets/images/guideitems/minko-avatar.jpg',
        'avatarUrl' : 'http://blog.mgechev.com',
        'author': 'Minko Gechev',
        'position': 'Angular Consultant',
        'header': 'assets/images/guideitems/angular-patterns-minko-header.jpg',
        'title':'10 AngularJS Patterns',
        ...
        'author': 'Minko Gechev',
        'position': 'Angular Consultant',
        'header': 'assets/images/guideitems/structure-minko-header.png',
        ...
        'avatarSrc': 'assets/images/guideitems/andy-avatar.png',
        'avatarUrl' : 'http://andyshora.com/',
        'author': 'Andy Shora',
        'position': 'Angular Consultant',
        'header': 'assets/images/guideitems/promises-header.png',
        ...
        'avatarSrc': 'assets/images/guideitems/code-school-avatar.png',
        'avatarUrl' : 'https://www.codeschool.com',
        'author': 'Campus codeschool',
        'position': 'Code school platform',
        'header': 'assets/images/guideitems/angular-patterns-codeschool-header.jpg',
        'title':'10 AngularJS Patterns',
        'content':' The goal of this style guide is to present a set of best practices and style guidelines for one AngularJS application.',
